...
from my_aitextgen.utils import GPT2Config
...
class Training:
    ...
    Drive, make sure you end training and save the results so you don't lose them!
    (if this happens frequently, you may want to consider using Colab Pro)
    ...
    def __init__(self, vocab_size, steps, batch_size, file_name):
    ...
    def get_aitextgen(self):
        ...
        # Downloading the 124M GPT-2 TensorFlow weights/config from Google's servers
    ...
    def training(self):
        ...
        **kwargs,
        ...
        # setting it too high will cause the GPU to go OOM.
        ai.train(data, batch_size=self.batch_size, num_steps=self.steps)  # 32
...
if __name__ == "__main__":
    ...
    batch_size = 48
    t = Training(VOCAB_SIZE, STEPS, batch_size, file_name)
    t.training()
